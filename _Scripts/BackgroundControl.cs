...
public class BackgroundControl : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        background.GetComponent<Image>().material = listMats[UserValidation.userList[UserValidation.activeUserIndex].backgroundChoice];
            ...
            if(SceneManager.GetActiveScene().name == "Main Player Menu")
        {
            ...
            displayBack.GetComponent<Image>().material = listMats[dropDownBack.value];
        }
    }
