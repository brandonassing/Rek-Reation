...
public class Weapon : MonoBehaviour
{
    ...
    public void SetType(WeaponType wt)
    {
        ...
        wing.GetComponent<Renderer>().material.color = def.color;
    ...
    //Added functino to control enemy firing
    public void EnemyFire()
    {
        ...
        switch (type)
        {
            case WeaponType.blaster:
                p = MakeProjectile();
                p.GetComponent<Rigidbody>().velocity = Vector3.down * 10;
                break;
            case WeaponType.spread:
                p = MakeProjectile();
                p.GetComponent<Rigidbody>().velocity = Vector3.down * 10;
                p = MakeProjectile();
                p.GetComponent<Rigidbody>().velocity = new Vector3(-0.2f, -0.9f, 0) * 10;
                p = MakeProjectile();
                p.GetComponent<Rigidbody>().velocity = new Vector3(0.2f, -0.9f, 0) * 10;
                break;
        }
